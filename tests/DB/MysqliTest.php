    ...
    public function test_compile_sql() {
        $cases = array(
            array(
                ...
                'field' => array(
                    'field1' => 'real_field1',
                    'field2' => array('', 'real_field2'),
                    'expr1' => array('expr', 'count(*)'),
                    'table' => 'test_table'
                ),
                'value' => array(
                    'value1' => 'real_value1<>%_',
                    'rich_value' => array('rich', 'rich_alue<>%_'),
                    'like_value' => array('like', 'like_value<>%_'),
                    'plain_value' => array('', 'plain_value<>%_'),
                    'expr' => array('expr', '23=12+5'),
                ),
